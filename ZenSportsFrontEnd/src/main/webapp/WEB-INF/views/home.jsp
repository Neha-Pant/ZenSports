<div class="container">
		...
		<div class="col-md-12" align="center">
			<div id="carausal" class="carousel slide" data-interval="3000"
				...
				<div class="carousel-inner" role="listbox">
					<div class="item active" class="img-responsive" style="width: 100%">
	...
	<div class="row" style="height: 50%;">
		<div class="col-md-12  jumbotron">
			<b style="font-size: 20pt">Buy Sports And Fitness Products Online
				At YenSports.com</b>
			...
			<p style="font-size: 10pt">
				Set Up Your Own Gym<br /> Fitness enthusiasts and those who love to
				...
				the range of yoga mats. The variety of chest expanders and exercise
				balls are quite motivational for a regular workout. With the
				exercise bikes or treadmill as they are known as, one could cycle
				for miles in the comfort of their homes. Gym owners or those who are
				looking to set up a gym at home would find all the home gym
				equipment they need.
			</p>
			<p style="font-size: 10pt">Brands offering fitness products
				include Adidas, Nike, Cosco, Reebok, Nivia and others. Most of these
